...
// Pattern 1:   
    ...
    var pattern = `\[(?<l0>[0-9]+)\,\[(?<n0>[0-9]+)\,(?<n1>[0-9]+)\]\]\,\[(?<l1>[0-9]+)\,\[\k<n1>\,(?<n2>[0-9]+)\]\]\,\[(?<l2>[0-9]+)\,\k<n1>\],\[\k<l2>\,\k<n2>\]\,\[\k<l1>\,\[\k<n0>\,(?<n3>[0-9]+)\]\]\,\[\k<l2>\,\k<n0>\]\,\[\k<l2>\,\k<n3>\]`;
...
// Pattern 2:   
    ...
    var pattern = `\[(?<l0>[0-9]+)\,\[(?<n0>[0-9]+)\,(?<n1>[0-9]+)\]\]\,\[(?<l1>[0-9]+)\,\[(?<n2>[0-9]+)\,\k<n1>\]\]\,\[(?<l2>[0-9]+)\,\k<n2>\]\,\[\k<l2>\,\k<n1>\]\,\[\k<l1>\,\[(?<n3>[0-9]+)\,\k<n0>\]\]\,\[\k<l2>\,\k<n3>\]\,\[\k<l2>\,\k<n0>\]`;
