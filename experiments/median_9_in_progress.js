...
function select_3_7_ab_ac_ad_eb_ef_fc_bd_bg(a,b,c,d,e,f,g,r) {
    if ( ! r(f, b)) {
        if ( ! r(d, f)) {
            if ( ! r(g, f)) {
                    return f;
...
// step 11 
function select_3_7_ab_ac_ad_eb_ef_fc_bd(a,b,c,d,e,f,g,r) {
    if ( ! r(g, b)) {
        if ( ! r(f, b)) {
            if ( ! r(d, f)) {
                if ( ! r(g, f)) {
...
function select_3_7_ab_ac_ad_eb_ef_fc(a,b,c,d,e,f,g,r) {
    if ( ! r(d, b)) {
        select_3_7_ab_ac_ad_eb_ef_fc_bd(a,c,e,f,b,d,g);
    } else {
        select_3_7_ab_ac_ad_eb_ef_fc_db(a,c,e,f,b,d,g);    
    }
}
...
function select_4_8_abd_cd_ef_bf_ce(a,b,c,d,e,f,g,h,r) {
    if ( ! r(g, b)) {
        ...
        //select_4_7_abd_cd_ce_fb(a,b,c,d,e,g,h,r);         //TODO: esto todavia no podemos generarlo con el generador de código (median_comp_tree.js), hay que hacer que funcione para seleciones no-medianas
        return null; //TODO
    }
}

// step 9, ver si puedo usar select_4_8_abd_cd_ef_bf_ce() reordenando los parámetros
