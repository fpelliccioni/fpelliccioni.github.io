...
Aquí el código escrito por Andrei para realizar una *búsqueda lineal* usando *sentinelas*. 
...
Aquí almacena el último elemento del rango en una variable temporal `c` 
