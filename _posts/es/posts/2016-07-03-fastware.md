...
var myAnim = setInterval(function(){
  // alert("fer");
  var nextImage = '/images/fm2gp_portada.jpg';
  var obj = $(".myImageHolder");
  ...
  var logo = document.getElementById('myImageHolder');
  logo.src = "/images/fm2gp_portada.jpg";
...
<!-- <img id="myImageHolder" src="/images/fmgp.jpg" style="width: 50%; height:80%;" /> -->
<img id="myImageHolder" style="width: 50%; height:80%;" />
<!-- <img id="myImageHolder" src="/images/fm2gp_portada.jpg" style="width: 50%; height:80%;" /> -->
...
La función toma como argumentos un *rango* y un *elemento* a ser buscado en dicho rango.  
