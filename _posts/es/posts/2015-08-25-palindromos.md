...
Considero que ninguno de los tres algoritmos presentados en éste artículo representan una solución definitiva, un [Componente]({% post_url es/posts/2014-10-28-components-programming %}).
