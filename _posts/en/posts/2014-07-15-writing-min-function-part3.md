...
This is the C++ equivalent of the min function code from [Part 2]({% post_url en/posts/2014-05-28-writing-min-function-part2 %}):
...
{% endhighlight %}
(We will see how to **define** the *TotallyOrdered* concept in C++ later. For now, think in the mathematical definition presented [before]({% post_url en/posts/2014-05-20-writing-min-function-part1 %})  )
...
*Partial Ordering*?  
No, we saw in [Part 1]({% post_url en/posts/2014-05-20-writing-min-function-part1 %}) that *Partial Ordering* is **too weak** to define min.
